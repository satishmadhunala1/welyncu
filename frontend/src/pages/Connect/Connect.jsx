...
const Connect = () => {
  ...
  const people = [
    {
      ...
      img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=1887&q=80",
      bgImg:
        "https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?auto=format&fit=crop&w=1972&q=80",
      rate: 2,
      rating: 4.8,
      projects: 42,
      available: true,
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=1887&q=80",
      bgImg:
        "https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?auto=format&fit=crop&w=2069&q=80",
      rate: 3,
      rating: 4.5,
      projects: 28,
      available: true,
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1554151228-14d9def656e4?auto=format&fit=crop&w=1886&q=80",
      bgImg:
        "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=2070&q=80",
      rate: 5,
      rating: 4.9,
      projects: 67,
      available: false,
    ...
    },
    {
      ...
      name: "David Chen",
      skill: "UI/UX Design",
      img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1887&q=80",
      bgImg:
        "https://images.unsplash.com/photo-1616587226157-48e49175ee20?auto=format&fit=crop&w=2070&q=80",
      rate: 4,
      rating: 4.7,
      projects: 35,
      available: true,
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1888&q=80",
      bgImg:
        "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=2070&q=80",
      rate: 2,
      rating: 4.6,
      projects: 51,
      available: true,
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1568992687947-868a62a9f521?auto=format&fit=crop&w=1888&q=80",
      bgImg:
  ...
  const filteredPeople = people.filter((person) => {
    ...
    const matchesCategory =
      ...
      selectedCategories.some((cat) =>
        person.skill.toLowerCase().includes(cat.toLowerCase())
      );
  ...
  return (
    <div className="flex min-h-screen text-white relative">
      {/* === Sidebar (Desktop) === */}
      <div className="hidden lg:block w-80 border-r border-gray-800 p-6 space-y-8 overflow-y-auto">
        <Sidebar
      ...
      <button
        className="lg:hidden fixed bottom-6 right-6 bg-green-600 text-white p-4 rounded-full shadow-lg z-40"
      ...
      {showFilters && (
        <div className="fixed inset-0 z-50 flex">
          ...
          />
          {/* Panel */}
          <div className="w-80 bg-gray-900 border-l border-gray-800 p-6 space-y-8 overflow-y-auto transform transition-transform duration-300 translate-x-0">
      ...
      <div className="flex-1 p-2 lg:p-6 overflow-y-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold">FIND EXPERTS</h1>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-gray-900 max-h-[90vh] overflow-y-auto rounded-2xl p-6 sm:p-8 max-w-md w-full relative border border-green-600/30 shadow-2xl">
            ...
            <style>{`
              ...
              ::-webkit-scrollbar-track { background: #1a1a1e; border-radius: 4px; }
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <p className="text-white font-bold text-2xl">
                    ${selectedPerson.rate * sessionLength}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-3 pt-2">
                <button
                  ...
                  onClick={() =>
                    alert(
                      `Starting instant session with ${selectedPerson.name} for ${sessionLength} minutes`
                    )
                  }
                >
    ...
    <>
      ...
      <div className="relative border border-gray-800 rounded-lg">
        ...
        <input
          ...
          className="pl-10 pr-4 py-3 w-full bg-transparent border-none focus:outline-none rounded-lg text-white"
          value={searchQuery}
      ...
      <div className="space-y-5">
        <h3 className="text-lg font-semibold flex items-center gap-2">
          <FaVideo className="text-green-500" /> Live Sessions
        </h3>
        <Link to="/live">
          <button className="w-full px-4 py-2 rounded-lg text-left transition-all text-green-400 border border-green-600/30 hover:bg-green-600/30">
      ...
      <div className="space-y-5">
        <h3 className="text-lg font-semibold flex items-center gap-2">
          <FaFilter className="text-green-500" /> Categories
        </h3>
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col space-y-2">
          {["all", "available", "scheduled"].map((status) => (
            <button
              key={status}
...
const ExpertCard = ({ person, setSelectedPerson }) => (
  <div className="border border-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative">
    <div className="h-32 w-full overflow-hidden">
      <img src={person.bgImg} alt="Background" className="w-full h-full object-cover" />
    </div>
    ...
    <div className="px-4 pb-4">
      ...
      <div className="flex justify-between items-start mt-2">
        <div className="flex-1">
          ...
          <p className="text-green-400 font-medium text-sm">{person.skill}</p>
        </div>
        {!person.available && (
          <div className="bg-gray-800 text-gray-300 text-xs px-2 py-1 rounded">Not available</div>
        )}
      </div>
      ...
      <div className="mt-3 text-sm text-gray-500 flex items-center justify-between">
        ...
        <div className="mt-3 flex items-center">
          <span className="text-white font-semibold">
            <span className="text-xl sm:text-2xl font-bold">${person.rate}</span>/min
          </span>
        </div>
      </div>
