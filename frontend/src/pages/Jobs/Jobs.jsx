          ...
          <div className='mt-4 grid md:grid-cols-3 lg:grid-cols-1 grid-cols-2 space-y-4'>
            <div>
              ...
              <div className='space-y-2 mt-2'>
                ...
                <label className='flex gap-2'><input type="checkbox" /> Part Time</label>
                <label className='flex gap-2'><input type="checkbox" /> Internship</label>
                <label className='flex gap-2'><input type="checkbox" /> Volunteering</label>
              </div>
            </div>
            ...
            <div>
              ...
              <div className='space-y-2 mt-2'>
                <label className='flex gap-2'><input type="checkbox" /> Full day</label>
                <label className='flex gap-2'><input type="checkbox" /> Flexible schedule</label>
                <label className='flex gap-2'><input type="checkbox" /> Part Time</label>
                <label className='flex gap-2'><input type="checkbox" /> Shift work</label>
              </div>
            </div>
            ...
            <div>
              ...
              <div className='space-y-2 mt-2'>
                ...
                <label className='flex gap-2'><input type="checkbox" /> In person</label>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4'>
            ...
            <div className='flex items-center gap-2'>
              <p className='text-gray-400 text-xs md:text-sm'>
                Sort by: <span className='text-gray-400 font-bold'>Last updated</span>
              </p>
              <FaSort />
            </div>
          </div>
            ...
            <div className='border border-gray-800 p-2 rounded-xl'>
              <div className='bg-green-400/20 w-full p-4 rounded-xl'>
                <div className='flex justify-between items-center'>
                  <p className='font-semibold text-sm md:text-base text-black bg-white px-3 py-1 rounded-full w-fit'>20 May,2025</p>
                ...
                <div className='mt-3'>
                  ...
                  <div className='flex items-center gap-2'>
                    <h2 className='font-bold text-lg md:text-xl leading-tight mt-2'>Senior UI/UX Designer</h2>
                    <img src='/amazon.webp' className='h-10 w-10 rounded-full object-cover' />
                  </div>
                </div>
                 <div className='flex items-center gap-2 flex-wrap mt-4'>
                  <p className='text-gray-300 text-xs md:text-sm font-semibold border border-gray-400 py-1 px-2 rounded-full'>Part Time</p>
                  <p className='text-gray-300 text-xs md:text-sm font-semibold border border-gray-400 py-1 px-2 rounded-full'>Senior level</p>
                  <p className='text-gray-300 text-xs md:text-sm font-semibold border border-gray-400 py-1 px-2 rounded-full'>Remote</p>
                  <p className='text-gray-300 text-xs md:text-sm font-semibold border border-gray-400 py-1 px-2 rounded-full'>2-5 years</p>
                </div>
              </div>
              <div className='mt-4 flex items-center justify-between'>
                <div>
                  <p className='font-bold text-lg md:text-xl'>$250/hr</p>
                  <p className='text-gray-400 text-sm md:text-base'>San Francisco, CA</p>
                </div>
                <button className='bg-white text-black text-sm md:text-base py-2 px-4 rounded-full font-semibold'>Details</button>
              </div>
            </div>
             ...
             <div className='border border-gray-800 p-2 rounded-xl'>
              <div className='bg-pink-400/20 w-full p-4 rounded-xl'>
                <div className='flex justify-between items-center'>
                  <p className='font-semibold text-sm md:text-base text-black bg-white px-3 py-1 rounded-full w-fit'>4 Feb,2025</p>
                  <div className='bg-white p-2 rounded-full text-black w-fit'>
                    <CiBookmark size={15} />
                  </div>
                </div>
                <div className='mt-3'>
                  ...
                  <div className='flex items-center gap-2'>
                    <h2 className='font-bold text-lg md:text-xl leading-tight mt-2'>Junior UI/UX Designer</h2>
              ...
              <div className='mt-4 flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-gray-400 text-sm md:text-base'>California, CA</p>
                </div>
                <button className='bg-white text-black text-sm md:text-base py-2 px-4 rounded-full font-semibold'>Details</button>
              </div>
            </div>
              ...
              <div className='bg-blue-500/20 w-full p-4 rounded-xl'>
                <div className='flex justify-between items-center'>
                  <p className='font-semibold text-sm md:text-base text-black bg-white px-3 py-1 rounded-full w-fit'>29 Jan,2025</p>
                  <div className='bg-white p-2 rounded-full text-black w-fit'>
                    <CiBookmark size={15} />
                  </div>
                </div>
                <div className='mt-3'>
                  ...
                  <div className='flex items-center gap-2'>
                    <h2 className='font-bold text-lg md:text-xl leading-tight mt-2'>Senior Motion Designer</h2>
              ...
              <div className='mt-4 flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-gray-400 text-sm md:text-base'>New York, NY</p>
                </div>
                <button className='bg-white text-black text-sm md:text-base py-2 px-4 rounded-full font-semibold'>Details</button>
              </div>
            </div>
