  ...
  return (
    ...
    {/* leftside */}
       <div className='md:flex   gap-4'> 
        ...
        {/* <MagicCard> */}
            <div className='p-4 rounded-xl bg-black/40 shadow-xl shadow-black lg:w-[200px] 2xl:w-[250px] w-full '>
              ...
              <h3 className='font-bold text-[20px] 2xl:text-[25px] mt-2'>Freelancing</h3>
              <p className='text-gray-400 text-[13px] 2xl:text-[15px] mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            {/* </MagicCard> */}
            {/* <MagicCard> */}
            <div className='p-4 rounded-xl bg-black/40 shadow-xl shadow-black lg:w-[200px] 2xl:w-[250px] w-full'>
              ...
              <h3 className='font-bold text-[20px] 2xl:text-[25px] mt-2'>Jobs</h3>
              <p className='text-gray-400 text-[13px] 2xl:text-[15px] mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            {/* </MagicCard> */}
        </div>
        ...
        {/* <MagicCard> */}
            <div className='p-4 rounded-xl bg-black/40 shadow-xl shadow-black lg:w-[200px]  2xl:w-[250px] w-full'>
              ...
              <h3 className='font-bold text-[20px] 2xl:text-[25px] mt-2'>Skill Exchange</h3>
              <p className='text-gray-400 text-[13px] 2xl:text-[15px] mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            {/* </MagicCard>
            <MagicCard> */}
            <div className='p-4 rounded-xl bg-black/40 shadow-xl shadow-black lg:w-[200px] 2xl:w-[250px] w-full'>
              ...
              <h3 className='font-bold text-[20px] 2xl:text-[25px] mt-2'>Learning</h3>
              <p className='text-gray-400 text-[13px] 2xl:text-[15px] mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            {/* </MagicCard> */}
        </div>
...
{/* rightside */}
       <div>
       <h1 className='font-bold font-barlow md:text-[40px] text-[30px] 2xl:text-[50px]'>What We are Offering For You?</h1>
